...
(2, 'HP -- pending pick up', 'pending pick up -- i7core, silver. brandnew. , easy wipe with damp cloth. Pick up only, cash only, Deer Run Stittsville. Will take table top off for easy transport.', 50, NULL, 'Ottawa', 'ON', 'K2B6B1', 'Canada', 1, '2018-11-22 10:00:55', NULL, NULL, 'General Laptop'),
(3, 'Toshiba', 'pending pick up ', 55, NULL, 'Gatineau', 'Montreal', 'QC', 'Canada', 2, '2018-11-22 22:03:11', NULL, NULL, 'Gaming Laptop'),
